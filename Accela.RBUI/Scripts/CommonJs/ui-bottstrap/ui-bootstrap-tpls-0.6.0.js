...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    ...
    "      <th><button type=\"button\" class=\"btn btn-default\" ng-click=\"move(-1)\"><span class=\"glyphicon glyphicon-chevron-left\"></span><i class=\"icon-chevron-left\"></i></button></th>\n" +
    ...
    "      <th><button type=\"button\" class=\"btn btn-default\" ng-click=\"move(1)\"><span class=\"glyphicon glyphicon-chevron-right\"></span><i class=\"icon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
    ...
    "        <button type=\"button\" style=\"width:34px;padding:8px;\"  class=\"btn btn-default text-center\" ng-class=\"{'btn-info': dt.selected}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{muted: dt.secondary}\">{{dt.label}}</span></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    //"	</tr>\n" +
    "	<tr>\n" +
    "		<td class=\"control-group\" ng-class=\"{'error': invalidHours}\"><input type=\"text\" ng-model=\"hours\" ng-change=\"updateHours()\" class=\"span1 text-center form-control\" ng-mousewheel=\"incrementHours()\" ng-readonly=\"readonlyInput\" maxlength=\"2\" /></td>\n" +
    "		<td>:</td>\n" +
    "		<td class=\"control-group\" ng-class=\"{'error': invalidMinutes}\"><input type=\"text\" ng-model=\"minutes\" ng-change=\"updateMinutes()\" class=\"span1 text-center form-control\" ng-readonly=\"readonlyInput\" maxlength=\"2\"></td>\n" +
    "		<td ng-show=\"showMeridian\"><button type=\"button\" ng-click=\"toggleMeridian()\" class=\"btn btn-default text-center\">{{meridian}}</button></td>\n" +
    "	</tr>\n" +
    //"	<tr class=\"text-center\">\n" +
